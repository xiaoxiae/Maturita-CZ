...
- detektivní (Pes baskervillský - Arthur Conan Doyle) a hororová (viz nahoře) literatura
- romantismus
  - odehrával se současně s různými národními obrozeními
  - v 18. století začíná průmyslová revoluce, která se nejvíce projevuje v 19. století (hlavně v Anglii)
    - romantismus se hlavně zajímal o negativní dopad průmyslové revoluce na přírodu – proto se často věnuje přírodním motivům
  - občanská válka Sever proti Jihu v USA (E.A. Poe se jí ale nedožil)
  - odklon od témat Boha a náboženství, jak tomu bylo v klasicismu
  - klade velký důraz na city – zaměřuje se na smutná až depresivní témata
  - ústřední postava bývá něčím jedinečná (individuální), nepochopená společností, cítí se být sama a uchyluje se na zvláštní často temná místa
    - temná prostředí: sklepení, hřbitovy, temný les, ponuré zámky a hrady
  - hlavní postavy často páchají sebevraždy nebo hledají nový život
  - idealismus = život v souladu s ideály (svoboda, láska)
  - revolta proti společnosti – proti zaběhlým konzervativním principům
  - inspiruje se často v gotice – gotické romány
  - **další autoři romantismu**
    - George Byron, Mary Shelly, Percy Bysshe Shelly
    - Jane Austen
    - Michail Lermontov
    - Alexander Puškin
    - Victor Hugo
...
- **Karel Hynek Mácha**
  - **Máj** -- Nejvýznamnější dílo českého romantismu, báseň o lásce, vině a trestu.
- **Karel Jaromír Erben**
  - **Kytice** -- Sbírka balad, které čerpají z českých a moravských lidových pověstí a legend.
